...
(function(self) {
    ...
    function _setRequestParams(opts) {
        // 这里是传给MA的参数
        var action = opts.action || 'handler',
    ...
    /**
     * 
     * @param {*string} url 后台的url 
     * @param {*json} opts {appid: 'test',action: 'handler',controller: 'test',timeout: 1500,headers: {}} 
     */
    ifbpm.callUrl = function(url, opts) {
        opts = opts || {}
